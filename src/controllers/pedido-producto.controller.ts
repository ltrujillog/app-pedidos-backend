...
export class PedidoProductoController {
  ...
  async get(
    ...
    return this.pedidoRepository.y(id).get(filter);
  }
  ...
  async create(
    ...
    return this.pedidoRepository.y(id).create(producto);
  }
  ...
  async patch(
    ...
    return this.pedidoRepository.y(id).patch(producto, where);
  }
  ...
  async delete(
    ...
    return this.pedidoRepository.y(id).delete(where);
  }
}
